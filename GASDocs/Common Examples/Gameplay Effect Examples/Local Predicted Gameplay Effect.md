### Experimental Example: Local Predicted *Gameplay Effect*
A second example shows a runtime (Dynamic?) *Gameplay Effect* created within a local predicted *Gameplay Ability*.
